...
export default function AdminPage() {
  ...
  return (
<div className="min-h-screen pb-24 font-sans" style={{background: '#FFF5ED'}}>
      <ConfirmModal
...
{/* Header */}
<header className="shadow-soft-xl sticky top-0 z-40 text-white border-b-2" style={{background: '#8B4367', borderColor: '#6F3554'}}>
  <div className="max-w-7xl mx-auto px-4 py-5 sm:px-6 flex items-center justify-between">
    <div className="flex items-center gap-4">
      <div className="w-12 h-12 rounded-2xl bg-white/95 flex items-center justify-center shadow-soft">
...
<section className="rounded-3xl p-6 sm:p-8 shadow-soft border-2" style={{background: '#FFFBF7', borderColor: '#E7E5E4'}}>
  <div className="flex items-center justify-between mb-8">
    <div className="flex items-center gap-4">
      <span className="w-12 h-12 flex items-center justify-center rounded-2xl text-2xl shadow-soft" style={{background: '#FFF0ED', color: '#8B4367'}}>
        🔥
      </span>
      <div>
    ...
    <span className="text-white px-5 py-2.5 rounded-2xl text-sm font-bold shadow-soft" style={{background: '#8B4367'}}>
