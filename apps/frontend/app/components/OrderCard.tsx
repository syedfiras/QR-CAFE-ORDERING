      ...
      <div className="p-5 pb-4 border-b-2 border-neutral-100">
        <div className="flex items-start justify-between mb-3">
          ...
          <div className="flex items-center gap-3">
            <div className="px-4 py-2 rounded-xl text-white font-bold text-lg shadow-soft" style={{background: '#8B4367'}}>
      ...
      <div className="p-5">
        ...
        <div className="pt-4 border-t-2 border-neutral-200 mb-5">
          <div className="flex items-center justify-between p-4 rounded-2xl" style={{background: '#FFF0ED'}}>
            ...
            <span className="text-3xl font-bold" style={{color: '#8B4367'}}>₹{total}</span>
          </div>
        </div>
        ...
        <div className="space-y-3">
          {order.status === "PENDING" && (
            <div className="grid grid-cols-2 gap-3">
              ...
              <button
                onClick={onPrepare}
                className="w-full px-4 py-3 rounded-2xl text-white font-bold text-sm shadow-soft active:scale-95 transition-all"
          ...
          {order.status === "PREPARING" && (
            <button
              onClick={onComplete}
              className="w-full px-4 py-3 rounded-2xl text-white font-bold text-sm shadow-soft-lg active:scale-95 transition-all"
              style={{background: '#8B4367'}}
            >
              Complete Order
            </button>
