                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <button
                                    ...
                                    className="w-12 h-12 rounded-2xl text-white font-bold text-2xl hover:shadow-glow active:scale-95 transition-all flex items-center justify-center shadow-elegant shrink-0 bg-primary-700"
                                >
                                    +
                                </button>
                            </div>
